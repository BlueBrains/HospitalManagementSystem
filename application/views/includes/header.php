...
<head>
    ...
    <!-- TABLE STYLES-->
    <link href="<? echo base_url();?>assets/js/dataTables/dataTables.bootstrap.css" rel="stylesheet" />   
    <!-- JQUERY.UI STYLES-->
    ...
    <!-- MORRIS CHART STYLES-->
    <link href="<? echo base_url();?>assets/js/morris/morris-0.4.3.min.css" rel="stylesheet" />    
        <!-- CUSTOM STYLES-->
