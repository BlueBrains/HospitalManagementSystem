...
<body>
	...
	<div id="body">
		<ul>
			<li>
				<div class="figure">
					<span>laboratory services</span> <img src="<?php echo base_url();?>/images/laboratory-services.jpg" alt="">
				</div>
				<div class="article">
					<p>
			...
			<li>
				<div class="figure">
					<span>radiology</span> <img src="<?php echo base_url();?>/images/radiology.jpg" alt="">
				</div>
				<div class="article">
					<p><h2>
						Please chose the photo Type
					</p></h2>
					<ul>
						<li>
							<a href="request" >x-ray</a>
						</li>
						<li>
							<a href="#" >ultrasound</a>
						</li>
			...
			<li>
				<div class="figure">
					<span>general services</span> <img src="<?php echo base_url();?>/images/general-services.jpg" alt="">
				</div>
				<div class="article">
					<p>
